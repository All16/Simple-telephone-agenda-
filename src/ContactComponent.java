...
public class ContactComponent extends JPanel {
    /**
     ...
     * @param address the address of the contact
     */
    public ContactComponent(int ID, String contactName, String contactNumber, String email, String address, int userID) {
